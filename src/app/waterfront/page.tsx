...
export const metadata: Metadata = {
  ...
  description:
    "Waterfront homes for sale in Tampa Bay — lakefront, bayfront, canal-access, and Gulf-front properties. Barrett Henry, REALTOR® at REMAX Collective. (813) 750-0926.",
