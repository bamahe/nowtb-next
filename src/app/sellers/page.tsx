      ...
      <section className="section-white">
        <div className="container-wide max-w-3xl mx-auto">
          ...
          <div className="font-body text-muted font-light text-base md:text-lg leading-relaxed space-y-5">
            ...
            <p>
              Whether you are{" "}
              <Link href="/sell-your-home" className="text-accent underline underline-offset-4 hover:text-accent/80">
              ...
              <a href="tel:8137337907" className="text-accent underline underline-offset-4 hover:text-accent/80">
                (813) 733-7907
              </a>{" "}
        ...
        <div className="container-wide max-w-3xl mx-auto">
          ...
          <div className="font-body text-muted font-light text-base md:text-lg leading-relaxed space-y-5">
            ...
            <p>
              ...
              <Link href="/home-valuation" className="text-accent underline underline-offset-4 hover:text-accent/80">
        ...
        <div className="container-wide max-w-3xl mx-auto">
          ...
          <div className="font-body text-muted font-light text-base md:text-lg leading-relaxed space-y-5">
            ...
            <p>
              ...
              disclose,{" "}
              <Link href="/contact" className="text-accent underline underline-offset-4 hover:text-accent/80">
                reach out
              </Link>{" "}
      ...
      <section className="section-dark">
        <div className="container-wide max-w-3xl mx-auto">
          ...
          <p className="text-center mt-12">
            <Link href="/guides/home-selling-guide" className="text-accent underline underline-offset-4 hover:text-accent/80 font-body text-sm font-light">
      ...
      <section className="section-white">
        <div className="container-wide">
          ...
          <p className="text-center mt-6">
            <Link href="/market-updates" className="text-accent underline underline-offset-4 hover:text-accent/80 font-body text-sm font-light">
